    ...
    <DIV opacity={Math.min(scrollFr*3.7, 1)} id='home'  className='nav-link home home-main'>
      ...
      <div className='home-main__content'>
        <div className='home-main__content_1'>
          <div id="user-detail-name" className='home-main__content_1--big_text'>
        ...
        <div className="home-main__content_2">
            <div className="home-main__content_2__outer">
                ...
                <p id="user-detail-intro">I'm Harshdeep, a passionate <span>fullstack web developer</span>. Specialized in <span>MERN stack</span> with <span>1500+</span> hours of hands on programming experience.</p>
            </div>
        </div>
      </div>
