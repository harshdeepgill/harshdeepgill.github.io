  ...
  return (
    ...
    <div id="nav-menu" className="navbar-main">
      ...
      <div className="resume-burger-div">
        <BUTTON className="nav-link resume"  id="resume-button-1"><a style={{display:"flex", alignItems: "center", textDecoration:"none", gap:"1rem", color: "rgb(22,22,22)"}} href={resume} target="_blank" download="resume" rel="noopener noreferrer" id="resume-link-1"><p>Resume</p> <DownloadIcon/></a></BUTTON>
        <Button onClick={onOpen} className="burger-menu"><HamburgerIcon /></Button>
      </div>
    </div>
      <Drawer placement={"left"} onClose={onClose} isOpen={isOpen}>
      <DrawerOverlay />
        <DrawerContent display={"flex"} flexDirection={"column"} justifyContent={"space-between"} bgColor={"rgb(22,22,22)"} p={"3rem"} w={"100vw"}>
          <DrawerBody>
